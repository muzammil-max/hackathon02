            ...
            <div className="w-full md:w-1/2 px-4 md:px-10 py-6 flex flex-col justify-center">
              ...
              <div className="text-[#505977] text-sm md:text-base">
                ...
                <div className="my-4 md:my-6">
                  <p>
                    A timeless design crafted from premium materials, this silky
                    vase stands out as one of our most iconic and sought-after
                    pieces. Its smooth, refined finish adds an elegant touch,
                    making it perfect for enhancing any stylish living space
